...
console.log('from erase all data kindly check');
...
const MONGO_URI = process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb+srv://vishalsinh:vishalsinh@cluster0.gf66tvi.mongodb.net/yarnflow';

console.log('Mongo_URI',MONGO_URI);
if (!MONGO_URI) {
  console.error('❌ Error: MONGODB_URI not found in ');
